...
module.exports = {
  content: ["./src/**/*.{astro,js,ts,tsx,jsx}"],
  presets: [],
  ...
  plugins: [
    ...
    function ({ addUtilities, theme }) {
      const utilities = {
        ".bg-stripes": {
          backgroundImage:
            "linear-gradient(135deg, var(--stripes-color) 10%,transparent 0,transparent 50%, var(--stripes-color) 0,var(--stripes-color) 60%,transparent 0,transparent)",
          // "linear-gradient(135deg, var(--stripes-color) 10%, transparent 50%, var(--stripes-color) 60%, transparent 62.50%, transparent 100%)",
