...
export const Chart = ({ data }: ChartProps) => {
  ...
  useEffect(() => {
    if (chartRef.current !== null && chartRef.current !== undefined) {
      ...
      const xScale = d3
        .scaleTime()
        .domain(d3.extent(glucoseData, d => d.date) as [Date, Date])
        .range([0, innerWidth]);
  ...
  return (
    <div className="w-auto h-96 m-10">
      <h3 className="text-2xl font-semibold leading-6 text-gray-900 text-center">Blood Glucose Data</h3>
