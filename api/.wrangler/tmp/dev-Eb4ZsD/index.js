...
__publicField(H, "generator", true);
function M(A, e3 = {}) {
...
function k(A, e3) {
  ...
  for (let [A2, n2] of t2.entries())
    "" === n2 && (n2 = null), void 0 === r2[A2] ? r2[A2] = n2 : Array.isArray(r2[A2]) ? r2[A2].push(n2) : r2[A2] = [r2[A2], n2], e3 && e3.shape[A2] && (g(e3.shape[A2]) && !Array.isArray(r2[A2]) ? r2[A2] = [r2[A2]] : g(e3.shape[A2]));
  return r2;
}
function Z(A, e3) {
...
function parseISO(argument, options) {
  ...
  if (dateStrings.timezone) {
    ...
    const dirtyDate = new Date(timestamp2 + time);
...
function getDefault(schema4) {
  return typeof schema4.default === "function" ? schema4.default() : schema4.default;
}
...
function object(entries, arg2, arg3, arg4) {
  ...
  return {
    ...
    _parse(input, info) {
      ...
      let issues;
      const output = {};
      for (const [key, schema4] of cachedEntries) {
        const value2 = input[key];
        const result = schema4._parse(value2, info);
        if (result.issues) {
          const pathItem = {
            type: "object",
            input,
...
function parse2(schema4, input, info) {
  const result = schema4._parse(input, info);
  if (result.issues) {
...
// src/endpoints/bloodGlucose.ts
var HKMetaDataSchema = object({
  "com.LoopKit.GlucoseKit.HKMetadataKey.GlucoseTrend": optional(string2()),
  "com.LoopKit.GlucoseKit.HKMetadataKey.GlucoseTrendRateUnit": optional(string2()),
  "com.LoopKit.GlucoseKit.HKMetadataKey.GlucoseTrendRateValue": optional(number())
});
var BloodGlucoseSchema = object({
  time: string2(),
  units: string2(),
  uploadId: string2(),
...
var BloodGlucoseLatest = class extends K {
  async handle(request, env, context, data) {
    ...
    const validData = parse2(BloodGlucoseSchema, responseData[0]);
    return validData;
  }
};
__publicField(BloodGlucoseLatest, "schema", {
  tags: ["Blood Glucose"],
...
__publicField(BloodGlucoseToday, "schema", {
  tags: ["Blood Glucose"],
...
// src/endpoints/insulinBolus.ts
init_checked_fetch();
init_modules_watch_stub();
var InsulinBolusSchema = object({
  uploadId: string2(),
  normal: number(),
  subType: string2(),
  type: string2(),
...
var InsulinBolusLatest = class extends K {
  async handle(request, env, context, data) {
    const startingDate = formatISO(startOfToday());
    const authUrl = "https://api.tidepool.org/auth/login";
    const authHeaders = {
    ...
    const responseData = await response.json();
    const validData = parse2(InsulinBolusSchema, responseData[0]);
    return validData;
  }
};
__publicField(InsulinBolusLatest, "schema", {
  tags: ["Insulin Bolus"],
...
var InsulinBolusToday = class extends K {
  async handle(request, env, context, data) {
    const startingDate = formatISO(startOfToday());
    const authUrl = "https://api.tidepool.org/auth/login";
    const authHeaders = {
    ...
    const responseData = await response.json();
    const validData = parse2(array(InsulinBolusSchema), responseData);
    return validData;
  }
};
__publicField(InsulinBolusToday, "schema", {
  tags: ["Insulin Bolus"],
  summary: "Get bolus insulin events today",
  parameters: {},
  responses: {
...
// src/endpoints/activity.ts
init_checked_fetch();
init_modules_watch_stub();
var MetricSchema = object({
  units: string2(),
  value: number()
});
var HKMetaDataSchema2 = object({
  HKAverageMETs: optional(string2()),
  HKElevationAscended: optional(string2()),
  HKIndoorWorkout: optional(number()),
  HKTimeZone: optional(string2()),
  HKWeatherHumidity: optional(string2()),
  HKWeatherTemperature: optional(string2())
});
var ActivitySchema = object({
  ...
  name: string2(),
  payload: optional(HKMetaDataSchema2),
  type: string2(),
  time: string2()
});
var ActivityRunningMonth = class extends K {
  async handle(request, env, context, data) {
    const endingDate = formatISO(endOfMonth(/* @__PURE__ */ new Date()));
    const startingDate = formatISO(startOfMonth(/* @__PURE__ */ new Date()));
    const authUrl = "https://api.tidepool.org/auth/login";
    const authHeaders = {
      Authorization: env.BASE64_AUTH
    };
    ...
    const responseData = await response.json();
    const validData = parse2(array(ActivitySchema), responseData);
    return validData.filter((activity) => activity?.name !== void 0 ? activity.name.startsWith("Running") : false);
  }
};
__publicField(ActivityRunningMonth, "schema", {
  tags: ["Activity"],
...
var ActivityRunningDays = class extends K {
  async handle(request, env, context, data) {
    ...
    const responseData = await response.json();
    const validData = parse2(array(ActivitySchema), responseData);
    return validData.filter((activity) => activity?.name !== void 0 ? activity.name.startsWith("Runnin") : false);
  }
};
__publicField(ActivityRunningDays, "schema", {
  tags: ["Activity"],
...
var ActivityCyclingDays = class extends K {
  async handle(request, env, context, data) {
    const { days } = data.params;
    const startingDate = formatISO(subDays(/* @__PURE__ */ new Date(), Number(days)));
    const endingDate = formatISO(/* @__PURE__ */ new Date());
    ...
    const responseData = await response.json();
    const validData = parse2(array(ActivitySchema), responseData);
    return validData.filter((activity) => activity?.name !== void 0 ? activity.name.startsWith("Cycling") : false);
  }
};
__publicField(ActivityCyclingDays, "schema", {
  tags: ["Activity"],
...
var ActivityCyclingMonth = class extends K {
  async handle(request, env, context, data) {
    const endingDate = formatISO(endOfMonth(/* @__PURE__ */ new Date()));
    const startingDate = formatISO(startOfMonth(/* @__PURE__ */ new Date()));
    const authUrl = "https://api.tidepool.org/auth/login";
...
__publicField(ActivityCyclingMonth, "schema", {
  tags: ["Activity"],
...
var ActivityCycling = class extends K {
  async handle(request, env, context, data) {
    ...
    while (!processedCycling) {
      ...
      const responseData = await response.json();
      const validData = parse2(ActivitySchema, responseData[0]);
...
__publicField(ActivityCycling, "schema", {
  tags: ["Activity"],
...
var ActivityRunning = class extends K {
  async handle(request, env, context, data) {
...
__publicField(ActivityRunning, "schema", {
  tags: ["Activity"],
...
// src/endpoints/carbohydrates.ts
init_checked_fetch();
init_modules_watch_stub();
var CarbohydrateSchema = object({
  net: optional(number()),
  units: optional(string2())
});
var HKMetaDataSchema3 = object({
  "com.loopkit.AbsorptionTime": number()
});
var CarbohydratesSchema = object({
  uploadId: string2(),
  nutrition: optional(object({ carbohydrate: CarbohydrateSchema })),
  payload: optional(HKMetaDataSchema3),
  type: string2(),
  time: string2()
});
var CarbohydratesLatest = class extends K {
  async handle(request, env, context, data) {
    const startingDate = formatISO(startOfToday());
    const authUrl = "https://api.tidepool.org/auth/login";
    const authHeaders = {
    ...
    const validData = parse2(CarbohydratesSchema, responseData[0]);
    return validData;
  }
};
__publicField(CarbohydratesLatest, "schema", {
  tags: ["Carbohydrates"],
...
var CarbohydratesToday = class extends K {
  async handle(request, env, context, data) {
    const startingDate = formatISO(startOfToday());
    const authUrl = "https://api.tidepool.org/auth/login";
    const authHeaders = {
    ...
    const responseData = await response.json();
    const validData = parse2(array(CarbohydratesSchema), responseData);
    return validData;
  }
};
__publicField(CarbohydratesToday, "schema", {
  tags: ["Carbohydrates"],
...
// src/endpoints/healthCheck.ts
init_checked_fetch();
init_modules_watch_stub();
var HealthCheck = class extends K {
  async handle(request, env, context, data) {
    return { status: "200 - OK" };
  }
};
__publicField(HealthCheck, "schema", {
  tags: ["HealthCheck"],
